...
public class ActivityLifecycleListener implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityStarted(@NonNull Activity activity) {
        iZooto.curActivity = activity;
        DebugFileManager.createExternalStoragePublic(activity, "onActivityStarted" + Util.getAndroidId(activity) + IZ_FCM_TOKEN_KEY + PreferenceUtil.getInstance(activity).getStringData(AppConstant.FCM_DEVICE_TOKEN), "[Log.e]->");
        storeForegroundData(activity, true);
