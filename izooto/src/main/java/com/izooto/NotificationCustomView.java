...
//                int notificaitionId = (int) System.currentTimeMillis();
                         ...
                         if (payload.getAct1name() != null && !payload.getAct1name().isEmpty()) {
                             expandedView.setViewVisibility(R.id.tv_btn1, 0);
                             String button1;
                         ...
                         if (payload.getAct2name() != null && !payload.getAct2name().isEmpty()) {
                             expandedView.setViewVisibility(R.id.tv_btn2, 0);
                             String button2;
...
//                    if (sIcon != null && !sIcon.isEmpty()) {
//                        shareIcon = Util.getBitmapFromURL(sIcon);
//
//                    }
    ...
    public static PendingIntent shareNotification(String url) {
        if(url!=null && !url.isEmpty()) {
            ...
            return PendingIntent.getActivity(iZooto.appContext, new Random().nextInt(100), sendIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        }
        else
        {
            Intent sendIntent = new Intent();
