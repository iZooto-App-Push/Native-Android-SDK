...
public class PulseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PulseAdapter(Context context, ArrayList<Payload> payloadModalArrayList, AlertDialog alertDialog, DrawerLayout mainDrawer) {
        this.payloadModalArrayList = payloadModalArrayList;
        PulseAdapter.context = context;
