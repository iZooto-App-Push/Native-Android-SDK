...
//                        catch (Exception ex)
//                        {
//                            DebugFileManager.createExternalStoragePublic(iZooto.appContext,ex.toString(),"[Log.e]->Exception");
//                        }
//
//                    }
//                }
    ...
    static void ShowFallBackResponse(String fallBackAPI,  final Payload payload) {
        RestClient.get(fallBackAPI, new RestClient.ResponseHandler() {
            ...
            void onSuccess(String response) {
                ...
                try
                {
                    Log.e("Response Data","Response "+fallBackAPI.toString());
                    JSONObject jsonObject=new JSONObject(response);
                    if(jsonObject!=null)
                    {
                        ...
                        Log.e("PayloadLink",payload.getLink());
